...
<template>
    ...
    <AppLayout :title="'Evaluasi & AAR'">
        ...
        <form @submit.prevent="submit" class="max-w-3xl space-y-6">
            ...
            <div class="card p-6">
                ...
                <div class="space-y-3">
                    <div v-for="m in members" :key="m.id" class="flex items-center justify-between gap-4">
                        <div>
                            <div class="text-sm font-medium t-ink">{{ m.name }}</div>
            ...
            <!-- AAR -->
            <div class="card p-6">
                <h3 class="font-semibold t-ink mb-4">After-Action Review (AAR)</h3>
                <label class="text-sm t-muted">Catatan Debriefing</label>
