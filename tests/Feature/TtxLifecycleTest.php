...
test('full ttx lifecycle: create -> team -> advance -> evaluate -> completed', function () {
    ...
    $Package = \App\Models\Package::create(['name' => 'Lif-' . uniqid(), 'slug' => 'lif-' . uniqid(), 'price_monthly' => 100, 'max_users' => 100, 'features' => ['ttx'], 'includes_all_modules' => false, 'is_active' => true]);
